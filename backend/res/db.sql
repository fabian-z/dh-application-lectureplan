...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lectureplan`.`eventView` (`id` INT, `courseName` INT, `lecturerSurname` INT, `date` INT, `startTime` INT, `endTime` INT, `room` INT, `confirmed` INT);

-- -----------------------------------------------------
-- Placeholder table for view `lectureplan`.`lectureView`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lectureplan`.`lectureView` (`id` INT, `lectureName` INT, `lecturerName` INT, `lecturerSurname` INT, `courseName` INT);
...
CREATE  OR REPLACE VIEW `eventView` AS
    SELECT 
        events.id,
        lectureView.courseName,
        lectureView.lecturerSurname,
        events.date,
        events.startTime,
        events.endTime,
        events.room,
    ...
    FROM
        ...
        lectureView
    WHERE
        events.lecture = lectureView.id;

-- -----------------------------------------------------
-- View `lectureplan`.`lectureView`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `lectureplan`.`lectureView`;
DROP VIEW IF EXISTS `lectureplan`.`lectureView` ;
USE `lectureplan`;
CREATE  OR REPLACE VIEW `lectureView` AS
    SELECT 
        lectures.id,
        lectures.name AS lectureName,
        lecturers.givenName AS lecturerName,
        lecturers.surname AS lecturerSurname,
    ...
    FROM
        ...
        courses
    WHERE
        lectures.course = courses.id
            AND lectures.lecturer = lecturers.id;
