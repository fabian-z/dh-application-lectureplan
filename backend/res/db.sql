...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lectureplan`.`eventView` (`id` INT, `field` INT, `year` INT, `surname` INT, `date` INT, `startTime` INT, `endTime` INT, `room` INT, `confirmed` INT);
